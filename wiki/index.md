...
- [Scoop and Flywheel Build Diagrams](knowledge/concepts/scoop-and-flywheel-build-diagrams.md) — line drawings for the scoop clamp, flywheel plate frame, VEX recut cassettes, and current red-extension/blue-launcher-box flywheel concept
