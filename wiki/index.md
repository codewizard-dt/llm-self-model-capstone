...
- [Research: Operator Layer — Current State](knowledge/sources/operator-layer-research.md) — state of the ROS 2 operator node and the separate `self_model_generator` offline packet/loop-closure surface
